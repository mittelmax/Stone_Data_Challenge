...
### Reading dataframes
df_stone = read_csv(paste0(wd, "/data/clean/stone_data_cleaned.csv"))
df_ipea_aggr = read_csv(paste0(wd, "/data/clean/ipea_aggr_cleaned.csv"))
df_ipea_state = read_csv(paste0(wd, "/data/clean/ipea_state_cleaned.csv"))
...
### Saving dataframe
write_csv(df_total, paste0("data/spine/spine_stone_ipea.csv"))