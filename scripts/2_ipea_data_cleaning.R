...
### Reading dataframes
df_papelao = read_csv(paste0(wd, "/data/raw/ipea_papelao.csv"))
df_ipca= read_csv(paste0(wd, "/data/raw/ipea_ipca.csv"))
df_varejo = read_csv(paste0(wd, "/data/raw/ipea_varejo.csv"), skip=1)
df_demissoes_velho = read_csv(paste0(wd, "/data/raw/ipea_demissoes_velho.csv"), skip=1)
df_demissoes_novo = read_csv(paste0(wd, "/data/raw/ipea_demissoes_novocaged.csv"), skip=1)
df_cambio = read_csv(paste0(wd, "/data/raw/ipea_cambio.csv"))
...
write_csv(df_ipea_aggr, paste0(wd, "/data/clean/ipea_aggr_cleaned.csv"))
write_csv(df_ipea_state,paste0(wd, "data/clean/ipea_state_cleaned.csv"))