...
df_cad = read_csv(paste0(wd, "/data/raw/cadastrais.csv"))
df_data = read_csv(paste0(wd, "/data/raw/tpv-mensais-treinamento.csv"))
df_siglas = read_csv(paste0(wd, "/data/raw/sigla_estados.csv"))
...
write_csv(df_correct, paste0(wd, "/data/clean/stone_data_cleaned.csv"))
